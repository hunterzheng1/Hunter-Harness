...
## [0.2.56] — hunter-harness / [0.2.53] — @hunter-harness/workflow-harness

### Fixed（2026-08-09 本地文件降噪与平台联调修订）

- **完整忽略 Harness 投影**：初始化与刷新除忽略 `.harness`、`.worktrees` 和 `harness-*` 目录外，还会根据已安装清单精确忽略共享脚本、协议、契约等 Harness 生成文件；不会扩大为忽略整个 Agent 配置目录。
